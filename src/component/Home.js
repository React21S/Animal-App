...
const Home = () => {
    return (
        <div className="home">
            ...
            <Link  to={{ pathname:"https://www.britannica.com/science/animal-behavior/History-and-basic-concepts"}}target="_blank" ><small> Read more</small></Link>
            </h3>
            <img src="https://source.unsplash.com/ZxNKxnR32Ng " alt="Lion"/>
        </div>
    );
};
